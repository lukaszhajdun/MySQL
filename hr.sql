...
FROM employees e
	JOIN employees ee on e.salary < ee.salary
	WHERE ee.employee_id = 182;

#8
SELECT e.first_name AS 'Employee F.Name', e.last_name AS 'Employee L.Name', 
m.first_name AS 'Boss F.Name', m.last_name AS 'Boss L.Name'
FROM employees e
...
FROM job_history jh
    ...
    WHERE jh.start_date >= "1993-01-01" AND jh.start_date <= "1997-07-31";
