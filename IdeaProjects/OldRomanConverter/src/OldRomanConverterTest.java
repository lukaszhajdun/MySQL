...
public class OldRomanConverterTest {

    private final String expectedOutput;
    private final int number;

    OldRomanConverter testObject = new OldRomanConverter();

        @Parameters(name = "should convert {1} to {0}")
        ...
        public OldRomanConverterTest (String expectedOutput, int number){
